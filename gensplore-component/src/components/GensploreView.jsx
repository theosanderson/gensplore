...
function GensploreView({ genbankString, searchInput: controlledSearchInput, setSearchInput: onSearchInputChange, setTitleCallback, fastaUrl, alignedSequence, alignmentParams }) {
